    ...
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <p class="mb-8 max-w-[270px] text-base text-gray-7">
                        We are a web development company that creates high-quality web solutions for business.
                    </p>
                    <div class="flex items-center -mx-3">
                        <a href="https://www.facebook.com/OnYourDigital?_rdc=1&_rdr"
                        ...
                        <a href="https://www.youtube.com/@digit-on4079" class="px-3 text-gray-7 hover:text-white">
                            <svg width="22" height="22" viewBox="0 0 16 12" fill="none"
                        ...
                        <a href="https://www.instagram.com/digiton_agency/" class="px-3 text-gray-7 hover:text-white">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"
                                 class="fill-current">
                                <path
                        ...
                        <a href="https://ma.linkedin.com/company/digiton-ma" class="px-3 text-gray-7 hover:text-white">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"
                                 class="fill-current">
                                <path
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="w-full mb-10">
                    <h4 class="text-lg font-semibold text-white mb-9">Important Links</h4>
                    <ul>
                        <li>
                            <a href="javascript:void(0)"
                               class="inline-block mb-3 text-base text-gray-7 hover:text-primary">
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
                <div class="w-full mb-10">
                    <h4 class="text-lg font-semibold text-white mb-9">Latest articles</h4>
                ...
                <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                    <div class="flex justify-center my-1 md:justify-end">
                        <p class="text-base text-gray-7">
                            &copy; {{ now()->year }} All rights reserved. Developed by
                            <a href="https://digiton.ma" rel="nofollow noopner" target="_blank"
